...
public class ViewDragHelper {
     ...
     * callback's
     * {@link t9.wristband.ui.widget.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link t9.wristband.ui.widget.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link t9.wristband.ui.widget.swipeback.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link t9.wristband.ui.widget.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system

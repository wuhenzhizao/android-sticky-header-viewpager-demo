package widget.listbuddies.lib.views;
...
import widget.listbuddies.lib.helpers.ListBuddiesAutoScrollHelper;
import widget.listbuddies.lib.provider.ScrollConfigOptions;
...
public class ListBuddiesLayout extends LinearLayout implements View.OnTouchListener, ObservableListView.ListViewObserverDelegate {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.layout_listbuddies, this, true);
    ...
    public void setmScrollTabHolder(ScrollTabHolder mScrollTabHolder){
